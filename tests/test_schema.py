...
from src.schema.models import Facility, NGO, DocumentExtraction, FacilityType, AffiliationType, BaseOrganization
...
def test_document_extraction():
    doc = DocumentExtraction(
        ...
        facilities=[
            Facility(name="Test Clinic", facilityTypeId=FacilityType.clinic)
        ],
        other_organizations=[]
    )
